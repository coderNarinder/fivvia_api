...
@section('content')
        <div class="m-c-heading">
            ...
            <a href="{{route('admin.slider.create')}}" class="main-button m-b-rounded" title="add slider">
          ...
          <div class="wrapper-shadow-inset">
             <div class="table-wrapper">
              <table class="dTable" id="example2" data-action="<?= route('admin.slider.records.ajax') ?>">
                <thead>
                <tr>
                 <th>Title</th>
                  <th>Type</th>
