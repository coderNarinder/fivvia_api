@if(getTemplateLayoutPath('temp_id') == 'template-1')
<!-- Vendors JS -->
<!-- <script src="/web_templates/template-1/js/vendor/modernizr-3.11.7.min.js"></script>
<script src="/web_templates/template-1/js/vendor/jquery-3.6.0.min.js"></script>
<script src="/web_templates/template-1/js/vendor/jquery-migrate-3.3.2.min.js"></script>
  Plugins JS  
<script src="/web_templates/template-1/js/plugins/swiper-bundle.min.js"></script>
<script src="/web_templates/template-1/js/plugins/popper.min.js"></script>
<script src="/web_templates/template-1/js/plugins/tippy-bundle.umd.min.js"></script>
<script src="/web_templates/template-1/js/plugins/jquery.magnific-popup.min.js"></script>
<script src="/web_templates/template-1/js/plugins/jquery.ajaxchimp.min.js"></script>
<script src="/web_templates/template-1/js/main.js"></script> -->
