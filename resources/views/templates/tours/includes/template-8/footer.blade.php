                    ...
                    <div class="sub-title">
                        ...
                        <div class="footer-contant">
                            ...
                            <div class="payment-card-bottom text-center d-flex">
                                <ul>
                                    <li>
                                        <a href="#"><img class="blur-up lazyload" src="/assets/images/visa.png"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="blur-up lazyload" src="/assets/images/mastercard.png"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="blur-up lazyload" src="/assets/images/paypal.png"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="blur-up lazyload" src="/assets/images/american-express.png"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="blur-up lazyload" src="/assets/images/discover.png"></a>
                                    </li>
                                </ul>
                            </div>
                            @endif
