                        ...
                        <div class="row">
                                                ...
                                                $arr = [
                                                    'image' => (object)[
                                                        'path' => [
                                                            ...
                                                            'image_path' => \Storage::disk('s3')->url('default/default_image.png')
                                                        ]
                                                    ]
                                                ];
                                            ...
                                            @if(!empty($product->media))
                                                @foreach($product->media as $k => $image)
                                                    ...
                                                    <div class="swiper-slide easyzoom easyzoom--overlay">
                                                        <a href="{{$img->path['image_path']}}">
                                                        <img class="blur-up lazyload" data-src="{{$img->path['image_path']}}" alt="">
                                                        </a>
                                                    </div>
                                                @endforeach
                                            @endif
                                ...
                                <div class="exzoom hidden w-100" id="exzoom">
                                    <div class="exzoom_img_box mb-2">
                                        ...
                                        @php
                                                    ...
                                                    @endphp
                                            <li><img class="" src="{{$img->path['image_path']}}" /></li>
                                        @endforeach
                                        @endif
                                        </ul>
                                    </div>
                            ...
                            <div class="@php if(!empty($product->media) && count($product->media) > 0){ echo 'col-lg-7'; } else { echo 'offset-lg-4 col-lg-4'; } @endphp rtl-text">
                                <div class="product-right inner_spacing">
                                    ...
                                    <h6 class="sold-by">
                                        <b> <img class="blur-up lazyload" data-src="{{$product->vendor->logo['image_path']}}" alt="{{$product->vendor->Name}}"></b> <a href="{{ route('vendorDetail', $product->vendor->slug) }}"><b> {{$product->vendor->name}} </b></a>
                                    </h6>
