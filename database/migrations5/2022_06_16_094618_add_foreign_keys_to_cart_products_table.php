...
class AddForeignKeysToCartProductsTable extends Migration
{
    ...
    public function down()
    {
        Schema::table('cart_products', function (Blueprint $table) {
            ...
            $table->dropForeign('cart_products_created_by_foreign');
            $table->dropForeign('cart_products_product_id_foreign');
            $table->dropForeign('cart_products_tax_category_id_foreign');
            $table->dropForeign('cart_products_tax_rate_id_foreign');
            $table->dropForeign('cart_products_variant_id_foreign');
            $table->dropForeign('cart_products_vendor_id_foreign');
        });
    }
}
