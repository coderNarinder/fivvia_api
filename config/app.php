...
return [
    ...
    */
    ...
    'API_DOMAIN' => env('API_DOMAIN', 'localhost:1000'),
    'business' => env('MAIN_DOMAIN', 'localhost:8000'),

    'backend' => env('ADMIN_DOMAIN', 'localhost:8888'),
    ...
    */
    ...
    'IMG_URL1' => env('IMG_URL1', ''),

    'FIT_URl' => env('FIT_URl', ''),

    'IMG_URL2' => env('IMG_URL2', ''),
