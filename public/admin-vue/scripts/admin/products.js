$(function() { 
 ...
 jQuery("form[name=addCategory]").validate({
    ...
    var dataTable = $('#example2').DataTable({
        ...
        columns: [
              { data: 'img_url', name: 'img_url',searchable:false,"bSortable": false, render: function ( data, type, row ){

                      $text  ='<img src="'+data+'" class="img-thumbnails" style="width:120px">';
             ...
             { data: 'adult_price', name: 'adult_price',"bSortable":true},
             { data: 'child_price', name: 'child_price',"bSortable":true},
