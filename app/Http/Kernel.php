...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'CheckMainDomainAuth' => \App\Http\Middleware\CheckMainDomainAuth::class,
        'IsMainDomainAuth' => \App\Http\Middleware\IsMainDomainAuth::class,
        'IsBusinessCompleted' => \App\Http\Middleware\IsBusinessCompleted::class,
