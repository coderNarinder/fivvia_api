...
class Product extends Model{
    ...
    public function product_images(){
        return $this->hasMany('App\Models\VendorMedia')->where('media_type',1);
    }
    public function product_image(){
        return $this->hasOne('App\Models\VendorMedia')->select('path','product_id','media_type')->where('media_type',1);
    }

    public function product_videos(){
        return $this->hasMany('App\Models\VendorMedia')->where('media_type',2);
    }
    public function product_video(){
        return $this->hasOne('App\Models\VendorMedia')->select('path','product_id','media_type')->where('media_type',2);
    }
