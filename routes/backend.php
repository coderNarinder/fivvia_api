...
Route::group(['middleware' => 'adminLanguageSwitch'], function () {
    Route::group(['middleware' => ['ClientAuth'], 'prefix' => '/client'], function () {
        ...
        Route::resource('customEvent', 'Client\CustomEventController')->middleware('onlysuperadmin');
        Route::post('banner/changeValidity', 'Client\CustomEventController@validity');
